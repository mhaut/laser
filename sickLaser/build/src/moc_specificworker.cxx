...
static const char qt_meta_stringdata_SpecificWorker[] = {
    "SpecificWorker\0\0RoboCompDifferentialRobot::TBaseState\0"
    "getBaseState()\0compute()\0"
};
...
void SpecificWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: { RoboCompDifferentialRobot::TBaseState _r = _t->getBaseState();
            if (_a[0]) *reinterpret_cast< RoboCompDifferentialRobot::TBaseState*>(_a[0]) = _r; }  break;
